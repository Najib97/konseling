        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="img/logo-SMK.png" alt="">
                <img class="logo-compact" src="img/logo-SMK-txt.png" alt="">
                <img class="brand-title" src="img/logo-SMK-txt.png" alt="">
            </a>
            ...
            <div class="header-content">
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">
                              <h3><b>Aplikasi Bimbingan Konseling
                                <br>SMK PGRI Kasembon</b></h3>
                            </div>
                        </div>
              ...
              <li class="nav-item dropdown header-profile">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  <a style="cursor:pointer" class="dropdown-item ai-icon" data-toggle="modal" data-target="#logoutModal">
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="table-zoompage.php">Zoom Page</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
				...
				<div class="copyright">
					<p><strong>Bimbingan Konseling Dashboard</strong> © 2022 All Rights Reserved</p>
				</div>
			</div>
        </div>
        <!--**********************************
