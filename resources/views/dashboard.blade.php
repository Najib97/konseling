...
@section('page-title', 'Dashboard Man')
<!-- isi bagian konten -->
...
<!-- row -->
	...
	<div class="form-head d-flex align-items-center mb-sm-4 mb-3">
		<div class="mr-auto">
			...
			<p class="mb-0">Bimbingan Konseling</p>
		</div>
				...
				<div class="card-body">
					<div class="media align-items-center">
						<div class="media-body mr-3">
							...
							<span>Jumlah Siswa Konseling</span>
						</div>
						<img style="width:50px" src="img/logo-SMK-txt.png" alt="">
					</div>
				</div>
				<div class="progress  rounded-0" style="height:4px;">
					<?php $c = 76/475;
					$avg = round((float)$c * 100);

					echo "<div class='progress-bar rounded-0 bg-secondary progress-animated' style='width:" .$avg."%; height:4px;' role='progressbar'>";
					 ?>
		...
		<div class="col-xl-6">
			<div class="card">
				<div class="card-header border-0 pb-0">
					<h3 class="fs-20 text-black mb-0 mr-2">Jumlah Siswa Konseling</h3>
						...
						<div class="card">
							<div class="card-header d-sm-flex d-block pb-0 border-0">
								<div class="mr-auto pr-3">
									<h4 class="text-black fs-20 mb-0">Persentase Konseling</h4>
								</div>
							</div>
							<div class="card-body">
								<div class="tab-content">
									<div class="d-flex flex-wrap align-items-center px-4 bg-light">
										<div class="mr-auto d-flex align-items-center py-3">
											...
											<div>
												<p class="fs-18 mb-2">Total Siswa yang Melakukan Bimbingan</p>
												<span class="fs-15 text-primary font-w600">562,084</span>
											</div>
										</div>
									</div>
